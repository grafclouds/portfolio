...
* **Cloud Lift & Shift (Amazon Web Services, Azure, Google Cloud, VMC@AWS)**
    ...
    * Build Cloud Site Networks, Transit Gateways, Regions Crossing
    * Virtual Networks (VPC), Routing and Subnets, IP Design
    * Ingress Traffic Design with Elastic IP, ALB, ELB, Classic Load Balancers
    * Build Site-to-Site VPN, On-Prem Cloud Bridges, BGP Anouncements
...
* **Cloud Optimisations**
    ...
    * Resource Analysis, Cost Cutting
* **Cloud Automation**
    ...
    * Infra Scheduler, Reduce Cloud Reduces on Non-Working Hours
...
* **Virtualization & Data Stores _(Vmware ESX, Hyper-V, Xen, Proxmox)_**
    ...
    * Continous Replication, Carbonite, Rsync, VMware HCX
* **Microsoft Servers**
...
- [x] [Ishak Arslan (Turkey)](Resumes/Ishak-Arslan.md): `Senior SecOps Expert, L2 Support`
...
#### 🏠 Address
- [x] [Head Office (Turkey)](https://grafclouds.com) `Rift2 Basiskele/Kocaeli`
